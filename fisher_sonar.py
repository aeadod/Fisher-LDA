...
for train_index,test_index in KF.split(X):
    ...
    #训练数据
    m1,m2 = average(X_train,Y_train)
    Sw = within_class(X_train,Y_train,m1,m2)
    Sb = between_class(m1,m2)
